...
class OFDM_loopback_BER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._delay_range = qtgui.Range(0, 1000, 1, 100, 200)
        ...
        self._noise_volt_range = qtgui.Range(0, 1, 0.010, 0, 200)
        ...
        self._freq_offset_range = qtgui.Range(-0.100, 0.100, 0.001, 0, 200)
